...
export class TacGiaService {
    ...
    createTacGia(data: any) {
        return this.apiService.createTacGia(data).subscribe((data) => {
    ...
    updateTacGia(id: number, data: any) {
        return this.apiService.updateTacGia(id, data).subscribe(
            (data) => {
    ...
    deleteTacGia(id: number) {
        return this.apiService.deleteTacGia(id).subscribe(
            (_) => {
